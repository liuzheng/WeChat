...
!function () {
    ...
    location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
    ...
    }]) : angular.module("exceptionOverride", []), angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "surviveCheckService", "subscribeMsgService", "stateManageService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p, h, M, y, C, v) {
        function w() {
        ...
        function b() {
            t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {timing: {initStart: Date.now()}}), s.init().then(function (n) {
                return h.log("initData", n), n.BaseResponse && "0" != n.BaseResponse.Ret ? (console.log("BaseResponse.Ret", n.BaseResponse.Ret), void(l.timeoutDetect(n.BaseResponse.Ret) || i.openConfirm({
                    className: "default ",
                ...
                }))) : (f.setUserInfo(n.User), f.setSkey(n.SKey), f.setSyncKey(n.SyncKey), u.addContact(n.User), u.addContacts(n.ContactList), d.initChatList(n.ChatSet), d.notifyMobile(f.getUserName(), m.StatusNotifyCode_INITED), C.init(n.MPSubscribeMsgList), e.$broadcast("root:pageInit:success"), h.setCheckUrl(f), h.log("getUserInfo", f.getUserInfo()), t.$broadcast("updateUser"), M.report(M.ReportType.timing, {timing: {initEnd: Date.now()}}), o(function () {
                ...
                }, 0), t.account = u.getContact(f.getUserName()), void T())
            })
        }

        function T() {
            t.debug && (F && o.cancel(F), y.start(4e4), F = o(function () {
        ...
        window._appTiming = {}, r.go("chat"), e.CONF = m, t.isUnLogin = !window.MMCgi.isLogin, t.debug = !0, t.isShowReader = /qq\.com/gi.test(location.href), window.MMCgi.isLogin && (b(), h.browser.chrome && !MMDEV && (window.onbeforeunload = function (e) {
            return e = e || window.event, e && (e.returnValue = "关闭浏览器聊天内容将会丢失。"), "关闭浏览器聊天内容将会丢失。"
        })), t.$on("newLoginPage", function (e, t) {
            console.log("newLoginPage", t), f.setSkey(t.SKey), f.setSid(t.Sid), f.setUin(t.Uin), f.setPassticket(t.Passticket), b()
        });
        var P, A;
        t.search = function () {
            P && o.cancel(P), P = o(function () {
        ...
        t.$on("ngDialog.opened", function (e, t) {
            v.change("dialog:open", !0), I = t, S()
        }), t.$on("ngDialog.closed", function () {
            v.change("dialog:open", !1), I = null
        ...
        var F;
        t.isIPad = h.isIPad, t.isMacOS = h.isMacOS, t.isWindows = h.isWindows, t.isCloseGiveMeFive = !t.isWindows || h.getLocalStorage().getItem("close_ad"), t.isCloseGiveMeFive || M.report(M.ReportType.WinAdPV, {count: 1}), t.closeGiveMeFive = function () {
            t.isCloseGiveMeFive = !0, M.report(M.ReportType.click2CloseAd, {count: 1}), h.getLocalStorage().setItem("close_ad", "1")
        }, t.clickAndClose = function () {
            M.report(M.ReportType.clickAndCloseAd, {count: 1}), h.getLocalStorage().setItem("close_ad", "1")
        }
    }])
}(), !function () {
    "use strict";
    ...
    angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p, h, M, y) {
        ...
        e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, e.$on("message:add:success", function (t, o) {
                ...
                if (a.MsgId == o.MsgId) {
                    switch (o.AppMsgType) {
                        case u.APPMSGTYPE_ATTACH:
                            a.MMAppMsgDownloadUrl = a.MMAppMsgDownloadUrl.replace("#MediaId#", o.MediaId)
                    }
            ...
            var i = angular.element(window), l = 230, f = 360, d = i.width(), g = i.height(), p = t.pageY, h = t.pageX;
            d - t.pageX < l && (h = t.pageX - l), g - t.pageY < f && (p = t.pageY - f), m.open({
                templateUrl: "profile_mini.html",
                className: "profile_mini_wrap scale-fade",
                top: p,
                left: h,
    ...
    "use strict";
    angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m) {
        function g() {
            var e = "undefined" != typeof F.textContent ? F.textContent : F.innerText, t = F.getElementsByTagName("img").length > 0;
            e.length > 0 || t ? f.change("sender:hasText", !0) : f.change("sender:hasText", !1)
        }

        function p() {
            window.getSelection ? (E = window.getSelection(), N = E.getRangeAt(0)) : N = document.selection.createRange()
        }

        function h() {
            N ? window.getSelection ? (E.removeAllRanges(), E.addRange(N)) : N.select() : M()
        }
        ...
        function y(e) {
            var t, o, n = "";
            if (window.getSelection)t = window.getSelection(), t.rangeCount > 0 && (o = t.getRangeAt(0).cloneRange(), o.collapse(!0), o.setStart(F, 0), n = o.toString().slice(-e)); else if ((t = document.selection) && "Control" != t.type) {
                var r;
                o = t.createRange(), r = o.duplicate(), r.moveToElementText(F), r.setEndPoint("EndToStart", o), n = r.text.slice(-e)
            }
            return n
        }
        ...
        function C(e, t) {
            var o, n;
            if (t || h(), window.getSelection) {
                !t && N ? (o = E, n = N) : (o = window.getSelection(), n = o.getRangeAt(0)), n.deleteContents();
                var r;
            ...
            } else n = t ? document.selection.createRange() : N, n.pasteHTML(e), n.select()
        }

        function v() {
            window.getSelection && (window.getSelection().getRangeAt(0).insertNode(P), A = P.offsetLeft, I = P.offsetTop - F.scrollTop, k.appendChild(P))
        }
            ...
            var o = n.open({
                template: "imageUploadPreview.html", controller: ["$scope", function (e) {
                    ...
                    e.src = "", e.send = function () {
                        o && (t.MediaId = o, c.appendMessage(t), c.sendMessage(t), n.close())
                    }, e.cancel = function () {
                        n.close(), t = null
        ...
        function S(e) {
            F.innerHTML = t.editAreaCtn = e || "", F.focus(), g(), f.change("sender:active", !0), e && (M(), p())
        }
        ...
        function T(e, t) {
            angular.extend(e, {onQueued: H, onProgress: H, onSuccess: H, onError: H}, t)
        }

        var E, N, P = document.getElementById("caretPosHelper"), A = 0, I = 0, F = document.getElementById("editArea"), k = F.parentNode, U = l.getShareObject("editingContents"), D = !1;
        $(F).on("input", function () {
            p()
        }).on("click", function () {
            p()
        ...
        t.$on("$destroy", function () {
            ...
            t && e != t && (U[t] = F.innerHTML), R = e, S(U[e])
            ...
            var e;
            s.isSupport() ? s.capture({
                ok: function () {
                    var t = c.createMessage({MsgType: r.MSGTYPE_IMAGE, Type: r.MSGTYPE_IMAGE});
                    e = w(t), s.upload(JSON.stringify(t), function (t) {
                        !t.BaseResponse || t.BaseResponse && 0 != t.BaseResponse.Ret ? (alert(MM.context("76a7e04")), e.close()) : (console.log("capture upload success"), e.update(r.API_webwxpreview + "?fun=preview&mediaid=" + t.MediaId, t.MediaId))
                    })
                }
            }) : "Win64" == navigator.platform && l.browser.msie ? alert(MM.context("82cf63d")) : confirm(MM.context("112a5c0")) && s.install()
        };
        var x, O;
        t.editAreaKeyup = function (e) {
            if (MMDEV && e.keyCode == r.KEYCODE_NUM2 && "@" == y(1)) {
                var o = c.getCurrentUserName();
                if (!l.isRoomContact(o))return;
                v(), O = function () {
                    x = null, O = null;
                    var e = i.getChatRoomMembersContact(o, "withoutMe");
                    p(), u.open({
                        ...
                        autoFoucs: !1,
                        container: angular.element(k)
                    })
                }, !x && O && O(), clearTimeout(x), x = setTimeout(function () {
                    O && O(), x = null
                }, 300)
            }
        }, t.editAreaKeydown = function (e) {
            if (g(), x)return void e.preventDefault();
            var o = e.keyCode;
            if (o == r.KEYCODE_ENTER) {
                if (e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) {
                    var n = "<br>";
                    if (!l.browser.msie && window.getSelection) {
                        var a = window.getSelection().focusNode.nextSibling;
                        do if (!a || a.nodeValue || "BR" == a.tagName)break; while (a = a.nextSibling);
                        a || (n += n)
                    }
                    t.insertToEditArea(n, !0), F.scrollTop = F.scrollHeight
                } else t.sendTextMessage();
                e.preventDefault()
            }
            83 == o && e.altKey && (t.sendTextMessage(), e.preventDefault()), (o >= 65 && 111 >= o || o >= 186 && 222 >= o) && u.close()
        }, t.editAreaBlur = function () {
            O = null, f.change("sender:active", !1)
        }, t.editAreaClick = function () {
            v()
        }, t.sendTextMessage = function () {
            if (u.close(), !t.editAreaCtn.replace(/<br\/?>/g, "").match(/^\s*$/)) {
                var e = c.createMessage({MsgType: r.MSGTYPE_TEXT, Content: t.editAreaCtn});
                c.appendMessage(e), c.sendMessage(e), U[c.getCurrentUserName()] = "", t.editAreaCtn = ""
            }
        }, t.$on("root:quoteMsg", function (e, t) {
            S(t + (F.innerHTML.replace("<br>", "") ? F.innerHTML : "<br>")), F.scrollTop = 9999
        }), t.insertToEditArea = function (e, o) {
            C(e, o), t.editAreaCtn = F.innerHTML
        }, t.sendTuzkiEmoji = function (e, t) {
            var o = c.createMessage({
                MsgType: r.MSGTYPE_EMOTICON,
                Content: e,
                EmojiFlag: r.EMOJI_FLAG_GIF,
                EMoticonMd5: e
            });
            o.MMPreviewSrc = r.RES_PATH + "images/icon/Tuzki/" + t, c.appendMessage(o), c.sendMessage(o)
        }, t.sendGif = function () {
        };
        var L = 10, G = 20, Y = {bmp: 1, png: 1, jpeg: 1, jpg: 1, gif: 0}, B = function (e) {
            V.cancelFile(e.MMFileId), e.MMFileStatus = r.MM_SEND_FILE_STATUS_CANCEL
        }, H = function () {
        }, j = {
            onQueued: function () {
                return "gif" == this.ext.toLowerCase() ? (this.MMSendMsg = c.createMessage({
                    MsgType: r.MSGTYPE_EMOTICON,
                    EmojiFlag: r.EMOJI_FLAG_GIF
                }), void function (e) {
                    V.makeThumb(e, function (t, o) {
                        o && (e.MMSendMsg.MMThumbSrc = o), c.appendMessage(e.MMSendMsg), console.log(o)
                    }, 1, 1)
                }(this)) : (this.MMSendMsg = c.createMessage({
                    MsgType: b(this.ext) ? r.MSGTYPE_IMAGE : r.MSGTYPE_APP,
                    FileName: this.name,
                    FileSize: this.size,
                    MMFileId: this.id,
                    MMFileExt: this.ext,
                    ...
                    MMCancelUploadFileFunc: B
                }), void(b(this.ext) ? !function (t) {
                    t.MMSendMsg.MMThumbSrc = "", V.makeThumb(t, function (o, n) {
                        (o || !n) && m.report(m.ReportType.uploaderError, {
                            text: "创建缩略图失败",
                            fileName: t.MMSendMsg.MMFileExt,
                            fileSize: t.MMSendMsg.FileSize
                        }), n && (t.MMSendMsg.MMThumbSrc = n), c.appendMessage(t.MMSendMsg), e.$digest()
                    })
                }(this) : c.appendMessage(this.MMSendMsg)))
            }, onProgress: function (e) {
                var o = this;
                t.$apply(function () {
                    o.MMSendMsg.MMFileStatus = r.MM_SEND_FILE_STATUS_SENDING, o.MMSendMsg.MMUploadProgress = parseInt(100 * e)
                })
            }, onSuccess: function (e) {
                if (0 == e.BaseResponse.Ret) {
                    var o = this.MMSendMsg;
                    o.MediaId = e.MediaId, c.sendMessage(o), t.$apply(function () {
                        o.MMFileStatus = r.MM_SEND_FILE_STATUS_SUCCESS
                    })
                ...
                m.report(m.ReportType.uploaderError, {
                    ...
                    o.MMSendMsg.MMFileStatus = r.MM_SEND_FILE_STATUS_FAIL, o.MMSendMsg.MMStatus = r.MSG_SEND_STATUS_FAIL
                })
            }
        }, K = {
            onQueued: function () {
                var e = c.createMessage({MsgType: r.MSGTYPE_IMAGE, Type: r.MSGTYPE_IMAGE});
        ...
        }, V = WebUploader.create({
            auto: !0,
            dnd: "#chatArea",
            paste: l.browser.webkit ? "#chatArea" : void 0,
            ...
            if (b(e.ext)) {
                if (e.size > 1024 * L * 1024)return alert(MM.context("8c88ff6") + L + "M"), !1
            } else if (e.size > 1024 * G * 1024)return alert(MM.context("0c9c48a") + G + "M"), !1;
            /untitled\d+.png/i.test(e.name) ? T(e, K) : T(e, j)
            ...
            var o = e.file;
            t.mediatype = b(o.ext) ? "pic" : "doc", t.uploadmediarequest = JSON.stringify(angular.extend(a.getBaseRequest(), {
                ClientMediaId: l.now(),
                TotalLen: o.size,
                StartPos: 0,
                DataLen: o.size,
    ...
    angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p) {
        ...
        t.pickConfig = {
            ...
            return angular.forEach(t.selectedUsers, function (e, o) {
                ...
                e.push({UserName: t.UserName, Uin: t.Uin})
    ...
    angular.module("Controllers").controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function (e, t, o, n, r, a, i, c, s, l, u, f) {
        ...
        function h(o, n, s, l, d) {
            ...
            var p = g.MMDigest, h = i.getContact(o), M = i.getContact(g.FromUserName);
    ...
    angular.module("Services").factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c) {
        var s = {
            globalData: {chatList: []}, init: function () {
                ...
                var c = t.defer(), s = this, l = o.API_synccheck + "?" + ["r=" + a.now(), "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncKey())].join("&");
                return window.synccheck && (window.synccheck.selector = 0), e.jsonp(l, {timeout: 35e3}).success(function (e) {
                    console.log("syncCheck success?!", e)
                }).error(function () {
                    window.synccheck && "0" == window.synccheck.retcode ? "0" != window.synccheck.selector ? s.sync().then(function (e) {
                        c.resolve(e)
                    }, function (e) {
                        console.log("syncCheck sync nothing", e), c.reject("sycn net error")
                    }) : c.reject(window.synccheck && window.synccheck.selector) : !window.synccheck || "1101" != window.synccheck.retcode && "1102" != window.synccheck.retcode ? window.synccheck && "1100" == window.synccheck.retcode ? r.loginout(0) : (c.reject("syncCheck net error"), i.report(i.ReportType.netError, {
    ...
    angular.module("Services").factory("chatFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function ($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
        ...
        var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, service = {
            setCurrentUserName: function (e) {
                ...
                t[2] ? (e.MMLocationDesc = t[1], e.MMLocationUrl = t[2]) : (e.MMLocationDesc = t[0], e.MMLocationUrl = t[1]), e.MMDigest += e.MMLocationDesc
                ...
                e.MsgType = confFactory.MSGTYPE_APP, e.AppMsgType = confFactory.APPMSGTYPE_READER_TYPE, e.MMCategory = 1 == t.category.count ? [t.category.item] : t.category.item, angular.forEach(e.MMCategory, function (e) {
                    e.pub_time = jQuery.format.date(1e3 * e.pub_time, "MM-dd");
                    var t = e.cover.split("|");
                    3 == t.length && (e.cover = t[0], e.width = t[1], e.height = t[2])
    ...
    angular.module("Services").factory("confFactory", ["$q", function () {
        ...
        var a = {
            LANG: r,
            EMOTICON_REG: 'img\\sclass="(qq)?emoji (qq)?emoji([\\da-f]*?)"\\stext=".*?"\\ssrc=".*?"\\s?',
        ...
        var d, m = window._contacts = {}, g = window._strangerContacts = {}, p = [], h = [], M = [], y = [], C = window._chatRoomMemberDisplayNames = {}, v = [], w = [], S = [], b = {}, T = {}, E = 0, N = [96095155], P = {
            isSelf: function () {
                ...
                return 0 == this.MemberList.length && 0 != this.ContactFlag ? !0 : e.MMInChatroom === !1 || e.MMInChatroom === !0 ? e.MMInChatroom : (angular.forEach(this.MemberList, function (t) {
                    return t.Uin == a.getUserInfo().Uin ? void(e.MMInChatroom = !0) : void 0
                }), e.MMInChatroom = e.MMInChatroom || !1, e.MMInChatroom)
            }, isReadOnlyContact: function () {
                return N.indexOf(this.Uin) > -1
                ...
                var t = A.getChatroomIdByUserName(e);
                return t && C[t] ? C[t][this.UserName] : ""
            ...
            contactChangeFlag: "", setCurrentContact: function (e) {
                ...
                e && (e.isContact || (e = f(e), e.MMOrderSymbol = this.getContactOrderSymbol(e)), e.ChatRoomId && e.UserName && (e.MMFromBatchget = !0), e.RemarkName = e.RemarkName && i.transformSpanToImg(e.RemarkName), e.NickName = e.NickName && i.transformSpanToImg(e.NickName), e.isShieldUser() || !e.isContact() && !e.isRoomContact() ? this.addStrangerContact(e) : this.addFriendContact(e))
                ...
                var n, r, a = this;
                return n = m[e], n || (n = a.getStrangerContacts(e)), o ? n : ((!n || c.isRoomContact(e) && 0 == n.MemberList.length) && (r = a.getChatroomIdByUserName(t), a.addBatchgetContact({
                    UserName: e,
                    ChatRoomId: r || ""
                })), n)
                    ...
                    f.resolve(e.ContactList), E = 0, console.time("addContactsHandler"), angular.forEach(e.ContactList, function (e) {
                        ...
                        t > -1 && v.splice(t, 1), c.isRoomContact(e.UserName) && e.MemberList && e.MemberList.length ? angular.forEach(e.MemberList, function (t) {
                            ...
                            o && o.isContact() || (t.HeadImgUrl = c.getContactHeadImgUrl({
                                ...
                                UserName: t.UserName,
                                Skey: a.getSkey()
                            }), d.addContact(t)), d.addChatroomMemberDisplayName(t, e.Uin);
                            var n = d.inContactsToGetList({UserName: t.UserName});
                            n > -1 && v.splice(n, 1)
                        }) : d.addChatroomMemberDisplayName(e, e.ChatRoomId)
...
////////////////// end liuzheng ////////////////////
    ...
    angular.module("Services").factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function (e, t, o, n, r, a, i, c) {
        var s = {
            getUUID: function () {
                var o = t.defer();
                return window.QRLogin = {}, e.jsonp(r.API_jsLogin).success(function () {
                }).error(function () {
                    200 == window.QRLogin.code ? o.resolve(window.QRLogin.uuid) : o.reject(window.QRLogin.code)
                }), o.promise
            }, getQrcode: function () {
            }, checkLogin: function (o, n) {
                var a = t.defer(), n = n || 0;
                return window.code = 0, e.jsonp(r.API_login + "?loginicon=true&uuid=" + o + "&tip=" + n + "&r=" + ~new Date, {timeout: 35e3}).success(function () {
                }).error(function (e) {
    ...
    angular.module("Services").factory("utilFactory", ["$q", "$rootScope", "confFactory", function (e, t, o) {
        ...
        var u = {
            ...
            getContactHeadImgUrl: function (e) {
                return (this.isRoomContact(e.UserName) ? o.API_webwxgetheadimg : o.API_webwxgeticon) + "?seq=0&username=" + e.UserName + "&skey=" + e.Skey + (e.MsgId ? "&msgid=" + e.MsgId : "") + (e.ChatroomId ? "&chatroomid=" + e.ChatroomId : "")
            },
            form: function (e, t) {
                t = t || {};
                var o, n = [];
    ...
    angular.module("Services").factory("notificationFactory", ["utilFactory", function (e) {
        ...
        function c(e, n) {
            ...
            var a, c;
            return g && i() && angular.isString(e) && n && (angular.isString(n.icon) || angular.isObject(n.icon)) && r() === l && (a = t(e, n)), c = o(a), h.push(c), M.autoClose && a && !a.ieVerification && a.addEventListener && a.addEventListener("show", function () {
                var e = c;
                setTimeout(function () {
                    e.close()
                }, M.autoClose)
    ...
    angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, o, n) {
        ...
        function u(e, t) {
            ...
            var o, n = !1;
            e.indexOf("-error") > 0 ? (n = !0, o = {Type: 2, Text: s(e, t)}) : o = {Type: 1, Text: s(e, t)}, p(o, n)
        }
        ...
        function d() {
            $(window).unload(function () {
                w.unload = g(t), v.push({type: T.runtime, data: w}), !P && v.push({
                    type: T.timing,
                    data: {fullTiming: r()}
        ...
        var y, C = 3e3, _ = [], v = [], w = {}, S = "reportService", b = m(), T = {
            jsError: "[js-error]",
    ...
    angular.module("Services").factory("mmHttp", ["$http", "$q", "$timeout", function (e, t, o) {
        function n(n) {
            ...
            var l = n.data, u = n.config, f = u.MMRetry, d = "undefined" == typeof f.count ? 3 : f.count, m = f.timeout || 15e3, g = f.serial, p = [], h = [], M = 0, y = t.defer(), C = 0;
    ...
    angular.module("Services").factory("subscribeMsgService", ["$rootScope", "contactFactory", "accountFactory", "confFactory", "utilFactory", function (e, t, o, n, r) {
        var a = [], i = {
            current: null, changeFlag: 0, init: function (e) {
                e.length > 0 && (this.changeFlag = Date.now()), this.add(e)
    ...
    this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", "$animate", function (a, i, c, s, l, u, f, d, m, g) {
        var p = a.find("body"), h = {
            ...
            open: function (l) {
                ...
                return S = y.container ? y.container : p, c(w)(v), g.enter(w, S), y.autoFoucs && w.focus(), y.controller && (angular.isString(y.controller) || angular.isArray(y.controller) || angular.isFunction(y.controller)) && m(y.controller, {
                    $scope: v,
                    $element: w
            ...
            if (a) {
                ...
                n.bind("paste", function () {
                    ...
                    c && clearTimeout(c), c = setTimeout(function () {
                        for (var i = e.innerHTML, s = -1, l = -1, u = 0, f = i.length; f > u && (-1 == s && r.substr(u, 1) != i.substr(u, 1) && (s = u), -1 == l && r.substr(r.length - u - 1, 1) != i.substr(i.length - u - 1, 1) && (l = u), !(-1 != s && -1 != l || s >= f - 1 - l)); ++u);
                        if (-1 != s && -1 != l) {
                            if (l = f - 1 - l, s >= l) {
                                u = s;
                                for (var d = r.substr(u + 1, 10); ++u < f;)if (d == i.substr(u, d.length)) {
                                    l = u;
                                    break
                                }
                                u == f && (l = f - 1)
                            }
                            "<" == i.substr(s - 1, 1) && --s, ">" == i.substr(l + 1, 1) && ++l;
                            var m = i.substring(s, l + 1), g = i.substr(0, s), p = i.substr(s + m.length), h = g.lastIndexOf("<"), M = g.lastIndexOf(">");
                            if (h > M && (m = g.slice(h) + m, g = g.slice(0, h)), h = m.lastIndexOf("<"), M = m.lastIndexOf(">"), h > M) {
                                var y = p.indexOf(">") + 1;
                                m += p.slice(0, y), p = p.slice(y)
                            }
                            var C = m.replace(/&nbsp;/g, " ").replace(new RegExp("<(?!br|" + o.EMOTICON_REG + ").*?>", "g"), "").replace(new RegExp("&lt;(br|" + o.EMOTICON_REG + "/?)&gt;", "g"), "<$1>").replace(/<img.*?class="(.*?)" text="(.*?)" .*?>/g, function () {
                            ...
                            e.innerHTML = g + C + "<span class='pasteCaretPosHelper'></span>" + p;
                            var _, v, w = n.find(".pasteCaretPosHelper")[0];
                            w && (document.createRange ? (_ = document.createRange(), _.setStartAfter(w), _.collapse(!1), v = window.getSelection(), v.removeAllRanges(), v.addRange(_)) : document.selection && (_ = document.body.createTextRange(), _.moveToElementText(w), _.collapse(!1), _.select()), w.parentNode.removeChild(w)), a.$setViewValue(g + C + p), c = null
                        }
                    }, 50)
                }), t.browser.msie ? n.bind("keyup paste", i) : n.bind("input", i);
                var s = a.$render;
                a.$render = function () {
                    s && s(), n.html() != a.$viewValue && n.html(a.$viewValue || "")
                }
            }
        }
    }
        ...
        restrict: "EA", templateUrl: "preview.html", scope: {imageList: "=", current: "="}, link: function (n, r) {
            ...
            function f() {
                ...
                t.onload = function () {
                    ...
                    1 > e && 1 > o ? c({scale: o > e ? e : o}) : 1 > e ? c({scale: e}) : 1 > o ? c({scale: o}) : d.css(y), angular.extend(E, y), g[0].src = t.src, n.isLoaded = !0, n.containerStyle = null, n.$digest()
                }, t.onerror = function () {
                    t.onerror = null, alert(MM.context("845ec73"))
                }, t.src = n.imageList[n.current].url
            }

            var d = r.find("#img_dom"), m = r.find("#img_opr_container"), g = d.find("#img_preview"), p = document.documentElement.clientWidth, h = document.documentElement.clientHeight - parseInt(m.css("bottom")) - parseInt(m.height());
        ...
        this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function (u, f, d, m, g, p, h, M, y) {
            ...
            var _ = {
                ...
                open: function (a) {
                    ...
                    var S;
                    l[u.latestID] = S = m.defer();
                    var b, T, E = e.isObject(w.scope) ? w.scope.$new() : p.$new();
                    return m.when(c(w.template || w.templateUrl)).then(function (t) {
                    ...
                    var n = m.defer(), r = {closeByEscape: !1, closeByDocument: !1};
    ...
    return {
        restrict: "EA", priority: 1e3, scope: !0, terminal: !0, link: function (e, o, n) {
            var r = [], u = {
                ...
                size: 0,
                visible: 687
            }, f = n.mmRepeat.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), d = f[2], m = (f[1], '<div ng-style="{height:topHeight}" class="top-placeholder"></div><div ng-repeat="' + n.mmRepeat + '">' + o.html() + '</div><div ng-style="{height:bottomHeight}" class="bottom-placeholder"></div>'), g = t(m)(e);
    ...
    return {
        restrict: "EA", scope: !0, templateUrl: "navRead.html", link: function (e) {
            e.subscribeMsgs = [], e.articleList = [], e.subscribeMsgs.defaultValue = !0, e.$watch(function () {
                ...
                m.current = e.currentItem = t, e.mmRepeatKeyboard.setSelectItem(t), a.go("read", {readItem: t})
            }
        }
    }
    ...
    return {
        ...
        link: function (t, o) {
            ...
            var u, m, g = t.pickConfig;
            g.opt.all = g.opt.all || {};
            var p = t.initList || [];
            t.contactList = r(c.pickContacts(g.types, g.opt, !0).result, p), t.selectList = t.selectList || [], i(), t.search = function () {
                u && e.cancel(u), u = e(function () {
                    if (t.keyword) {
                        c.searchKey = t.keyword, m && m.close();
                        var e = $.extend(d(t.selectList), g.opt.all.filterContacts), o = $.extend({}, g.opt, {
                            all: $.extend({}, g.opt.all, {
                                noHeader: !0,
                                keyword: t.keyword,
                                filterContacts: e
                            })
                        });
                        t.contactList = c.pickContacts(g.types, o, !0).result, i(!0)
                    } else t.contactList = r(c.pickContacts(g.types, g.opt, !0).result, p), i(!0)
                }, 200)
